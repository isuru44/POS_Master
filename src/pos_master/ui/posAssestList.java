 ...
 * @author LENOVO
 */
public class posAssestList extends javax.swing.JFrame {

    /**
     * Creates new form posAssestList
     */
    public posAssestList() {
        initComponents();
        setExtendedState(posAssestList.MAXIMIZED_BOTH);
    }
    ...
    private void initComponents() {
        ...
        tblAssestList = new javax.swing.JTable();
        ...
        tblAssestList.setBackground(new java.awt.Color(0, 204, 204));
        tblAssestList.setFont(new java.awt.Font("Tempus Sans ITC", 1, 18)); // NOI18N
        tblAssestList.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {

            },
            new String [] {
                "Assest ID", "Assest Type", "Assest Name "
            }
        ));
        jScrollPane2.setViewportView(tblAssestList);
    ...
    private void refresh1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_refresh1ActionPerformed
        ...
        try{
            ...
            DefaultTableModel model = (DefaultTableModel) tblAssestList.getModel();
            while(db.rs.next()){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(posAssestList.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new posAssestList().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTable tblAssestList;
